...
1. **bee をインストールする**
   ...
   [はじめに](../../getting-started/) の手順に従って bee をインストールし、`bee auth login` で認証を完了してください。
...
<LinkCard title="AI エージェントで使えるプロンプト集" href="../../recipes/useful-prompts" description="bee と AI エージェントを組み合わせた実践的なプロンプト例" />
