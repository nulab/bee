...
<LinkCard title="⚙️ 環境変数" href="../guides/environment-variables/" description="環境変数でデフォルトのプロジェクトなどを設定する" />
<LinkCard title="🔄 CI/CD" href="../integrations/ci-cd/" description="GitHub Actions などの CI/CD パイプラインとの連携" />
<LinkCard title="🤖 AI エージェント" href="../integrations/ai-agent/" description="Claude Code や GitHub Copilot など AI エージェントとの連携" />
