...
<CardGrid>
  <LinkCard title="auth login" href="/bee/commands/auth/login/" description="ログイン" />
  <LinkCard title="auth logout" href="/bee/commands/auth/logout/" description="ログアウト" />
  <LinkCard title="auth status" href="/bee/commands/auth/status/" description="認証状態の確認" />
  <LinkCard title="auth switch" href="/bee/commands/auth/switch/" description="スペースの切り替え" />
  <LinkCard title="auth token" href="/bee/commands/auth/token/" description="トークンの表示" />
  <LinkCard title="auth refresh" href="/bee/commands/auth/refresh/" description="OAuth トークンの更新" />
</CardGrid>
