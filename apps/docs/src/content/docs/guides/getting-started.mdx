---
title: はじめに
description: bee のインストールと基本的な使い方。Node.js 20 以上が必要です。
---
...
1. **ログイン**
   ...
   :::tip
   API キーは Backlog の **個人設定 > API** から発行できます。詳しくは[認証ガイド](/guides/authentication/)を参照してください。
   :::
...
2. **課題を一覧表示する**
   ...
   :::tip
   プロジェクトキーは Backlog のプロジェクト URL に含まれています（例: `https://xxx.backlog.com/projects/MY_PROJECT` の `MY_PROJECT` 部分）。
   :::
